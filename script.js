...
var speed = 30; /* speed of the effect in ms */
var i = 0;
...
function nextText() { /* create the main function */
  ...
  if ( currentText == 2 ) {
    mc.txt = "J'ai changé d'école aussi alors je suis seul dans cette nouvelle ville. Je vien de me perdre acause de ce \"clicker sur la flèche pour passer au texte suivant\".";
  }
  if ( currentText == 3 ) {
